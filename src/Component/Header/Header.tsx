    ...
    return (
        <>
            <div style={{ backgroundColor: '#002d5b', color: 'white', display: 'flex', padding: '10px' }}>
                <p style={{ color: 'white', margin: '0 0px' }}><i className="fas fa-map-marker-alt" style={{ marginLeft: '100px', marginRight: '10px' }}></i>
                ...
                <p style={{ color: 'white', margin: '0 50px' }}>
                    ...
                    <a href='tel:(703) 910-3888' className="phone" style={{ color: 'white' }}>(703) 910-3888</a>
                </p>
            </div>
