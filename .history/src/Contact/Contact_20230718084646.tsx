          ...
          <Row className='Contact'>
            <Col md={8}>
              <iframe
                ...
                width="850" height="450" style={{ border: 0 }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </Col>
            <Col md={4}>
              <p className='title_contact'>Thanks for your interest. Please contact us with the information below.</p>
